...
1. Instalar dependencias (ver que las librerias esten instaladas con el comando mvn install )
...
4. reinicio servidor apache Tomcat para que tome los cambios que realicé en el codigo: docker restart tomcat9
